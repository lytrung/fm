...
class NewsletterOptionEntity extends \MailPoet\Entities\NewsletterOptionEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionEntity' . "\0" . 'value', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionEntity' . "\0" . 'newsletter', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionEntity' . "\0" . 'option_field', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionEntity' . "\0" . 'updated_at'];
        }
    ...
    public function setOptionField($option_field)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOptionField', [$option_field]);

        return parent::setOptionField($option_field);
    }
