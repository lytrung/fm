...
class UserFlagEntity extends \MailPoet\Entities\UserFlagEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\UserFlagEntity' . "\0" . 'user_id', '' . "\0" . 'MailPoet\\Entities\\UserFlagEntity' . "\0" . 'name', '' . "\0" . 'MailPoet\\Entities\\UserFlagEntity' . "\0" . 'value', '' . "\0" . 'MailPoet\\Entities\\UserFlagEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\UserFlagEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\UserFlagEntity' . "\0" . 'updated_at'];
        }
