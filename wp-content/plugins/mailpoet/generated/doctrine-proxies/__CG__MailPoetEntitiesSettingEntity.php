...
class SettingEntity extends \MailPoet\Entities\SettingEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\SettingEntity' . "\0" . 'name', '' . "\0" . 'MailPoet\\Entities\\SettingEntity' . "\0" . 'value', '' . "\0" . 'MailPoet\\Entities\\SettingEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\SettingEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\SettingEntity' . "\0" . 'updated_at'];
        }
