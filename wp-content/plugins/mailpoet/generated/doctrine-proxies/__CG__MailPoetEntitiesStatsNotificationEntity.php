...
class StatsNotificationEntity extends \MailPoet\Entities\StatsNotificationEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\StatsNotificationEntity' . "\0" . 'newsletter', '' . "\0" . 'MailPoet\\Entities\\StatsNotificationEntity' . "\0" . 'task', '' . "\0" . 'MailPoet\\Entities\\StatsNotificationEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\StatsNotificationEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\StatsNotificationEntity' . "\0" . 'updated_at'];
        }
