...
class NewsletterOptionFieldEntity extends \MailPoet\Entities\NewsletterOptionFieldEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionFieldEntity' . "\0" . 'name', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionFieldEntity' . "\0" . 'newsletter_type', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionFieldEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionFieldEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\NewsletterOptionFieldEntity' . "\0" . 'updated_at'];
        }
    ...
    public function setNewsletterType($newsletter_type)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNewsletterType', [$newsletter_type]);

        return parent::setNewsletterType($newsletter_type);
    }
