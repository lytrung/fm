...
class NewsletterSegmentEntity extends \MailPoet\Entities\NewsletterSegmentEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MailPoet\\Entities\\NewsletterSegmentEntity' . "\0" . 'newsletter', '' . "\0" . 'MailPoet\\Entities\\NewsletterSegmentEntity' . "\0" . 'segment', '' . "\0" . 'MailPoet\\Entities\\NewsletterSegmentEntity' . "\0" . 'id', '' . "\0" . 'MailPoet\\Entities\\NewsletterSegmentEntity' . "\0" . 'created_at', '' . "\0" . 'MailPoet\\Entities\\NewsletterSegmentEntity' . "\0" . 'updated_at'];
        }
