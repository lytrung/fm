...
class NewsletterEntity extends \MailPoet\Entities\NewsletterEntity implements \MailPoetVendor\Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setGaCampaign($ga_campaign)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGaCampaign', [$ga_campaign]);

        return parent::setGaCampaign($ga_campaign);
    }
