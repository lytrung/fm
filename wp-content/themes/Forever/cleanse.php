...
<section class="banner-section prod-detail-section cleanse-section">
    <div class="banner-box cleanse-banner-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-8 col-12 stage-detail-content">
                    <div class="display-table">
                        <div class="table-cell">
                            <h2><span><img
                                        src="<?php echo get_stylesheet_directory_uri(); ?>/images/cleanse-number1.png"
                                        alt=""></span><?php the_field('heading'); ?></h2>
                            <p><?php the_field('content'); ?></p>
                            <p><a href="<?php the_field('url'); ?>">View product</a></p>
                        </div>
                    </div>
                </div>	
            </div>
